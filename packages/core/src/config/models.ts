...
export const PREVIEW_GEMINI_ROBOTICS_MODEL = 'gemini-robotics-er-1.6-preview';

export const VALID_GEMINI_MODELS = new Set([
  PREVIEW_GEMINI_MODEL,
  PREVIEW_GEMINI_FLASH_MODEL,
  PREVIEW_GEMINI_ROBOTICS_MODEL,
...
/**
 * Models that are currently available on the free tier.
 */
export const FREE_GEMINI_MODELS = new Set([PREVIEW_GEMINI_ROBOTICS_MODEL]);
